...
export const getArtworks = (query) => {
    ...
    return fetch("https://api.artic.edu/api/v1/artworks/search?limit=100&fields=artist_title,id,title,image_id,style_title,date_end,place_of_origin,medium_display,dimensions&params=" + encodedSearchParams)
        .then(resp => resp.json())
        .then(results => {
